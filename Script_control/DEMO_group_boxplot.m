% DEMO Statistical analysis for the evolution of modularity development
...
hLegend=legend([boxchi(1),boxchi(8)], ["Bayesian Modelling", "Group Averaging"],'location','southeast' );
...
if scan==1
    results_path=fullfile(data_path,['../results/','roi_',num2str(N_roi),'_AP','_statistical_analysis']);
    save(results_path); 
    saveas(gcf,['../figures/','roi_',num2str(N_roi),'_AP','_statistical_analysis_modular_evolution.fig'])
elseif scan==2
    results_path=fullfile(data_path,['../results/','roi_',num2str(N_roi),'_PA','_statistical_analysis']);
    save(results_path); 
    saveas(gcf,['../figures/','roi_',num2str(N_roi),'_PA','_statistical_analysis_modular_evolution.fig'])
end
