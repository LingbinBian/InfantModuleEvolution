...
group_results=scio.loadmat('/home/lingbin/Documents/work/pythonProject/BCP_fMRI/results/roi_'+str(N_roi)+'_1_'+scan+'/'+str(resolution)+'/labels_'+scan+'_ave')
K_max=group_results['label_'+scan+'_ave'].max()
for i in range(9):
   community_label=group_results['label_'+scan+'_ave'][:,i]
